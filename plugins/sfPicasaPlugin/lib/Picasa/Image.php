		...
		if ($albums != null) {
			...
			if (array_key_exists("media", $namespaces)) {
				...
				if ($thumb != null) {
				    ...
				    $this->smallThumb = (string) $thumbAtt['url'];
				} else {
				...
				if ($thumb != null) {
				    $thumbAtt = $thumb->attributes();
				    $this->mediumThumb = (string) $thumbAtt['url'];
				} else {
				...
				if ($thumb != null) {
				    $thumbAtt = $thumb->attributes();
				    $this->largeThumb = (string) $thumbAtt['url'];
				} else {
			...
			if (array_key_exists("gphoto", $namespaces)) {
				...
				$this->albumTitle = (string) $gphoto_ns->albumtitle;
				$this->albumDescription = (string) $gphoto_ns->albumdesc;
