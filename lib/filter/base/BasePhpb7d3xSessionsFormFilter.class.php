...
/**
 * Phpb7d3xSessions filter form base class.
 *
 * @package    sf_sandbox
 * @subpackage filter
 * @author     Your name here
 */
abstract class BasePhpb7d3xSessionsFormFilter extends BaseFormFilterPropel
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('phpb7d3x_sessions_filters[%s]');
