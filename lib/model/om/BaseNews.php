...
abstract class BaseNews extends BaseObject  implements Persistent {
	...
	public function setPrevImg($v)
	{
		...
		if ($this->prev_img !== $v) {
			$this->prev_img = $v;
			$this->modifiedColumns[] = NewsPeer::PREV_IMG;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->prev_img = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->resetModified();
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setPrevImg($arr[$keys[10]]);
	}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::PREV_IMG)) $criteria->add(NewsPeer::PREV_IMG, $this->prev_img);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this News has previously been saved, it will retrieve
	 * related News2commentss from storage. If this News is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collNews2commentss === null) {
			if ($this->isNew()) {
			   $this->collNews2commentss = array();
				...
				$criteria->add(News2commentsPeer::NEWS_ID, $this->id);
	 ...
	 */
	public function getNews2commentssJoinComments($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(NewsPeer::DATABASE_NAME);
		}
		...
		if ($this->collNews2commentss === null) {
			if ($this->isNew()) {
				...
				$this->collNews2commentss = News2commentsPeer::doSelectJoinComments($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
