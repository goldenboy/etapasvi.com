...
abstract class BaseMailPeer {
	...
	const CLASS_DEFAULT = 'lib.model.Mail';
	...
	/**
	 * An identiy map to hold any loaded instances of Mail objects.
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'CreatedAt', 'Sent', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'createdAt', 'sent', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::CREATED_AT, self::SENT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'created_at', 'sent', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CreatedAt' => 1, 'Sent' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'createdAt' => 1, 'sent' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::CREATED_AT => 1, self::SENT => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'created_at' => 1, 'sent' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(MailPeer::SENT);
	}
	 ...
	 *
	 * @param      Mail $value A Mail object.
	 * @param      string $key (optional) key to use for instance map (for performance boost if key was already calculated externally).
	 */
	public static function addInstanceToPool(Mail $obj, $key = null)
	{
	...
	{
		// invalidate objects in MailI18nPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	{
		return $withPrefix ? MailPeer::CLASS_DEFAULT : MailPeer::OM_CLASS;
	}

	/**
	 * Method perform an INSERT on the database, given a Mail or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMailPeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMailPeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMailPeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseMailPeer', $values, $con, $pk);
    }
	...
	/**
	 * Method perform an UPDATE on the database, given a Mail or Criteria object.
	 *
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMailPeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseMailPeer', $values, $con))
      {
        return $sf_hook_retval;
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(MailPeer::ID, $criteria->remove(MailPeer::ID), $comparison);
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseMailPeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseMailPeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the mail table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += MailPeer::doOnDeleteCascade(new Criteria(MailPeer::DATABASE_NAME), $con);
			$affectedRows += BasePeer::doDeleteAll(MailPeer::TABLE_NAME, $con);
	...
	/**
	 * Method perform a DELETE on the database, given a Mail or Criteria object OR a primary key value.
	 *
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// for more than one table or we could emulating ON DELETE CASCADE, etc.
			$con->beginTransaction();
			$affectedRows += MailPeer::doOnDeleteCascade($criteria, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		$objects = MailPeer::doSelect($criteria, $con);
		foreach ($objects as $obj) {


			// delete related MailI18n objects
			$criteria = new Criteria(MailI18nPeer::DATABASE_NAME);
			
			$criteria->add(MailI18nPeer::ID, $obj->getId());
			$affectedRows += MailI18nPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	 ...
	 */
	public static function doValidate(Mail $obj, $cols = null)
	{
		$columns = array();
	...
	/**
	 * Selects a collection of {@link Mail} objects with a {@link MailI18n} translation populated.
	 *
	 * @param Criteria  $criteria
	...
	static public function doSelectWithI18n(Criteria $criteria, $culture = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
	  ...
	  MailPeer::addSelectColumns($criteria);
	  $startcol = (MailPeer::NUM_COLUMNS - MailPeer::NUM_LAZY_LOAD_COLUMNS);
	  MailI18nPeer::addSelectColumns($criteria);
	  // http://bsds.etapasvi.com/issues/113 
	  //$criteria->addJoin(MailPeer::ID, MailI18nPeer::ID, $join_behavior);
	  //$criteria->add(MailI18nPeer::CULTURE, $culture);
	  $criteria->addJoin(array(MailPeer::ID, MailI18nPeer::CULTURE), array(MailI18nPeer::ID, "'$culture'"), $join_behavior);
	
	  foreach (sfMixer::getCallables('BaseMail:doSelectJoin:doSelectJoin') as $sf_hook)
	  {
	    call_user_func($sf_hook, 'Mail', $criteria, $con);
	  }
	  ...
	  $stmt = BasePeer::doSelect($criteria, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
	      ...
	      MailPeer::addInstanceToPool($obj1, $key1);
			...
			$key2 = MailI18nPeer::getPrimaryKeyHashFromRow($row, $startcol);
			if ($key2 !== null) {
				$obj2 = MailI18nPeer::getInstanceFromPool($key2);
				if (!$obj2) {
					$cls = MailI18nPeer::getOMClass(false);
					$obj2 = new $cls();
					$obj2->hydrate($row, $startcol);
					MailI18nPeer::addInstanceToPool($obj2, $key2);
				} // if obj2 already loaded
	
	      $obj1->setMailI18nForCulture($obj2, $culture);
