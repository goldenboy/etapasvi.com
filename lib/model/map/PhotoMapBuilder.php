...
class PhotoMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addForeignKey('PHOTOALBUM_ID', 'PhotoalbumId', 'INTEGER', 'photoalbum', 'ID', false, null);
		...
		$tMap->addColumn('IMG', 'Img', 'VARCHAR', false, 255);

		$tMap->addColumn('FULL_PATH', 'FullPath', 'VARCHAR', false, 255);

		$tMap->addColumn('PREVIEW_PATH', 'PreviewPath', 'VARCHAR', false, 255);

		$tMap->addColumn('THUMB_PATH', 'ThumbPath', 'VARCHAR', false, 255);

		$tMap->addColumn('LINK', 'Link', 'VARCHAR', false, 255);

		$tMap->addColumn('PREV_IMG', 'PrevImg', 'VARCHAR', false, 255);
